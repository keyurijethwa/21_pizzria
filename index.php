<?php
  ...
  $q1="SELECT * FROM slider where sr_no=1";
  $q2="SELECT * FROM slider where sr_no=2";
  $q3="SELECT * From slider where sr_no=3";
  $a=mysqli_fetch_array(mysqli_query($con,$q1));
  $b=mysqli_fetch_array(mysqli_query($con,$q2));
  $c=mysqli_fetch_array(mysqli_query($con,$q3));
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="carousel-item active">
        <div class="row p-5">
          <div class="col-lg-6 col-md-6 col-sm-12 px-5">
            <img src="slider_image/<?php echo $a['1'];?>" class="d-block w-100 img-fluid" alt="...">
          </div>
        </div>
        <div class=" col-lg-6 col-md-6 col-sm-12 text-end top-50 my-auto mx-auto carousel-caption d-none d-md-block">
          <h2 class="fonts text-warning"><?php echo $a['2'];?></h2>
          <p class="fs-2"><?php echo $a['3'];?></p>
        </div>
        <div class=" mx-auto carousel-caption d-sm-block d-md-none">
          <h2 class="text-warning fonts"><?php echo $a['2'];?></h2>
          <p class="fs-2"><?php echo $a['3'];?></p>
        </div>
      </div>
      <div class="carousel-item">
        <div class="row d-flex p-5">
          <div class="col-lg-6 col-md-6 col-sm-12 p-5">
            <img src="slider_image/<?php echo $b['1'];?>" class="d-block w-100 img-fluid" alt="...">
          </div>
          <div class=" col-lg-6 col-md-6 col-sm-12 text-end top-50 my-auto mx-auto carousel-caption d-none d-md-block">
            <h2 id="fonts " class="text-warning"><?php echo $b['2'];?></h2>
            <p class="fs-2"><?php echo $b['3'];?></p>
          </div>
          <div class=" mx-auto carousel-caption d-sm-block d-md-none">
            <h2 class="fonts"><?php echo $b['2'];?> </h2>
            <p class="fs-2"><?php echo $b['3'];?></p>
          </div>
        </div>
      </div>
      <div class="carousel-item">
        <img src="slider_image/<?php echo $c['1'];?>" class="d-block w-100" alt="...">
        <div class="carousel-caption  d-block centered mt-5">
          <h1 class="fonts text-warning"><?php echo $c['2'];?></h1>
          <p class="fs-2"><?php echo $c['3'];?></p>
        </div>
      </div>
    </div>
    ...
    <div class=" container-fluid text-white p-5 ">
      <div class="row justify-content-center mb-5 pb-3 ">
        <div class="col-md-7 heading-section ftco-animate text-center">
          <h2 class="mb-4 text-warning">Read our blog</h2>
      ...
      <div class="row d-flex ">
        <div class="col-md-4 d-flex ">
          <div class="blog-entry ">
            <a href="home.php">
              <img src="img/image_3.jpg" alt="" height="40%" width="70%" class="rounded shadow">
            </a>
        ...
        <div class="col-md-4 d-flex ">
          <div class="blog-entry ">
            <a href="home.php">
              <img src="img/image_5.jpg" alt="" height="40%" width="70%" class="rounded shadow">
            </a>
            <div class="text py-4 d-block">
              <div class="meta">
                <div><a href="#"><i class="fa-solid fa-calendar-days"></i> Sept 10, 2018</a></div>
        ...
        <div class="col-md-4 d-flex ">
          <div class="blog-entry ">
            <a href="home.php">
              <img src="img/image_6.jpg" alt="" height="40%" width="70%" class="rounded shadow">
            </a>
            <div class="text py-4 d-block">
              <div class="meta">
                <div><a href="#"><i class="fa-solid fa-calendar-days"></i> Sept 10, 2018</a></div>
